    ...
    */
    const Container = vue.defineComponent((props, { attrs, slots, emit }) => {
        ...
        return () => {
            ...
            let propsToAdd = Object.assign(Object.assign({}, props), { ref: containerRef, class: getElementClasses(containerRef, classes), onClick: handleClick, onVnodeBeforeMount: (modelUpdateEvent) ? onVnodeBeforeMount : undefined });
            if (modelProp) {
...
const IonRouterOutlet = vue.defineComponent({
    ...
    setup(_, { attrs }) {
        ...
        vue.watch(matchedRouteRef, (currentValue, previousValue) => {
            /**
...
const IonNav = vue.defineComponent({
    ...
    setup(_, { slots }) {
        ...
        return () => {
            return vue.h('ion-nav', { delegate }, slots);
        };
    }
});
